(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("splunk-events", [], factory);
	else if(typeof exports === 'object')
		exports["splunk-events"] = factory();
	else
		root["splunk-events"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _concat = __webpack_require__(115);
	...
	var SplunkEvents = function () {
	  ...
	  _createClass(SplunkEvents, [{
	    ...
	    value: function config(_config) {
	      ...
	      this.debug = _config.debug || false;
	      this.debounceTime = _config.debounceTime || 2000;
	      this.debounceMaxWait = _config.debounceMaxWait || 5000;
	      this.debouncedFlush = (0, _debounce2.default)(this.flush, this.debounceTime, {}, false, this.debounceMaxWait);
	    ...
	    value: function logEvent(event) {
	      ...
	      event = (0, _extend2.default)(event, this.getAdditionalInfo());
	    ...
	    value: function flush() {
	      ...
	      this.pendingEvents = (0, _clone2.default)(this.events);
	      this.events = [];
	      ...
	      this.axiosInstance.post(this.path, splunkBatchedFormattedEvents).then(function (response) {
	        ...
	        _this.events = (0, _concat2.default)(_this.events, _this.pendingEvents);
	        _this.pendingEvents = [];
	        _this.isSendingEvents = false;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isObject = __webpack_require__(2),
	    ...
	    toNumber = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isIterateeCall = __webpack_require__(14),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toNumber = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflect = __webpack_require__(27),
	    iteratorToArray = __webpack_require__(30);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var checkGlobal = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var stubArray = __webpack_require__(85);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cloneArrayBuffer = __webpack_require__(96),
	    cloneDataView = __webpack_require__(98),
	    cloneMap = __webpack_require__(99),
	    cloneRegExp = __webpack_require__(103),
	    cloneSet = __webpack_require__(104),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addMapEntry = __webpack_require__(100),
